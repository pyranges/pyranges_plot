...
- Plotly legends/colorbars should also be anchored below the plotting area with enough bottom margin. Use one horizontal categorical legend with explicit labels like Matplotlib (`Strand: +`, `Feature: exon`) and horizontal quantitative colorbars stacked below the panels in color-then-outline order.
